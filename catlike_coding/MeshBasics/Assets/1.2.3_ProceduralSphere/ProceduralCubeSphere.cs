...
/// <summary>
/// Creates a cube. Cube has no duplicate vertices.
/// </summary>
...
public class ProceduralCubeSphere : MonoBehaviour
{
    ...
    /// <param name="t">triangle array start index</param>
    /// <param name="ring">Number of vertices in a ring</param>
    /// <returns>Last index of triangle array</returns>
